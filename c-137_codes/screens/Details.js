        ...
        <View style={styles.container}>
          ...
          >
            <View>
              ...
              <Text
                style={styles.cardItem}
              >{`Orbital Speed : ${this.state.details.orbital_speed}`}</Text>
              <Text
                style={styles.cardItem}
              >{`Planet Mass : ${this.state.details.planet_mass}`}</Text>
              <Text
                style={styles.cardItem}
              >{`Planet Radius : ${this.state.details.planet_radius}`}</Text>
              <Text
                style={styles.cardItem}
              >{`Planet Type : ${this.state.details.planet_type}`}</Text>
            </View>
            <View style={[styles.cardItem, { flexDirection: "column" }]}>
              <Text>{this.state.details.specifications ? `Specifications : ` : ""}</Text>
